...
public class StoreAggregatesException extends Exception implements TBase<StoreAggregatesException, StoreAggregatesException._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("StoreAggregatesException");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(StoreAggregatesException.class, metaDataMap);
  }
